...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ----------------------------------------------------------
    if ($action === 'create') {
        // --- single_event bestimmen (0 = ein Mitarbeiter, 1 = mehrere Mitarbeiter) ---
    ...
    if ($action === 'edit') {
        ...
        // Mitarbeiter-Zuweisung validieren
        if ($singleEvent === 0) {
...
// Struktur: id, employer_id, employer_ids, single_event, user_id,
//           date, date_to, start_time, end_time, category, color, is_all_day, title
...
$events = [
    ...
    [
        'id' => 5, 'employer_id' => 2, 'employer_ids' => [2], 'single_event' => 0, 'user_id' => 2,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '09:00', 'end_time' => '10:30',
        'category' => 'meeting', 'color' => '#4a90e2', 'is_all_day' => false,
        'title' => 'Project Review'
    ],
    [
        'id' => 6, 'employer_id' => 2, 'employer_ids' => [2], 'single_event' => 0, 'user_id' => 2,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '11:00', 'end_time' => '12:00',
        'category' => 'appointment', 'color' => '#e74c3c', 'is_all_day' => false,
        'title' => 'Customer Meeting'
    ],
    [
        'id' => 7, 'employer_id' => 2, 'employer_ids' => [2], 'single_event' => 0, 'user_id' => 2,
    ...
    [
        'id' => 14, 'employer_id' => 3, 'employer_ids' => [3], 'single_event' => 0, 'user_id' => 3,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '', 'end_time' => '',
        'category' => 'meeting', 'color' => '#3498db', 'is_all_day' => true,
        'title' => 'All-Day Meeting'
    ],
    [
        'id' => 15, 'employer_id' => 3, 'employer_ids' => [3], 'single_event' => 0, 'user_id' => 3,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '', 'end_time' => '',
        'category' => 'training', 'color' => '#9b59b6', 'is_all_day' => true,
        'title' => 'Training'
    ],
    [
        'id' => 16, 'employer_id' => 3, 'employer_ids' => [3], 'single_event' => 0, 'user_id' => 3,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '', 'end_time' => '',
        'category' => 'workshop', 'color' => '#e74c3c', 'is_all_day' => true,
        'title' => 'Team Building'
    ],
    [
        'id' => 8, 'employer_id' => 3, 'employer_ids' => [3], 'single_event' => 0, 'user_id' => 3,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '08:30', 'end_time' => '10:00',
        'category' => 'workshop', 'color' => '#1abc9c', 'is_all_day' => false,
        'title' => 'Workshop'
    ],
    [
        'id' => 9, 'employer_id' => 3, 'employer_ids' => [3], 'single_event' => 0, 'user_id' => 3,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '13:00', 'end_time' => '14:00',
        'category' => 'meeting', 'color' => '#4a90e2', 'is_all_day' => false,
        'title' => 'Status Update'
    ],
    [
        'id' => 10, 'employer_id' => 3, 'employer_ids' => [3], 'single_event' => 0, 'user_id' => 3,
    ...
    [
        'id' => 11, 'employer_id' => 4, 'employer_ids' => [4], 'single_event' => 0, 'user_id' => 4,
    ...
    [
        'id' => 12, 'employer_id' => 4, 'employer_ids' => [4], 'single_event' => 0, 'user_id' => 4,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '10:00', 'end_time' => '11:30',
        'category' => 'meeting', 'color' => '#4a90e2', 'is_all_day' => false,
        'title' => 'Team Sync'
    ],

    // Beispiel: Mehrfach-Mitarbeiter-Termin (single_event = 1) – Max, Anna und Peter
    [
        'id' => 17, 'employer_id' => null, 'employer_ids' => [1, 2, 3], 'single_event' => 1, 'user_id' => 1,
        'date' => date('Y-m-d'), 'date_to' => date('Y-m-d'), 'start_time' => '12:00', 'end_time' => '13:00',
        'category' => 'meeting', 'color' => '#8e44ad', 'is_all_day' => false,
        'title' => 'Gemeinsames Mittagstreffen'
    ],
];
